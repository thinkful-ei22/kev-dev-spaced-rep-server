...
describe('Japanese API - Words', function () {
  ...
  // describe('GET /api/progress/next', function () {

  //   it('should return the head', function () {
  //     return Promise.all([
  //       Word.find({_id: user.id}),
  //       chai.request(app).get('/api/progress/next')
  ...
  //         expect(res).to.include.all.keys('untranslated', 'phonetic', 'translation');
  //       });
  //   });
